...
const VERSION = 'bedeem-v10';
const SHELL = ['./', 'index.html', 'styles.css?v=10', 'app.js?v=10', 'sources.json', 'books.json', 'books-ledelse.json', 'manifest.webmanifest', 'icon.svg', 'icon-192.png'];
