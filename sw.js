...
const VERSION = 'bedeem-v9';
const SHELL = ['./', 'index.html', 'styles.css?v=9', 'app.js?v=9', 'sources.json', 'books.json', 'books-ledelse.json', 'manifest.webmanifest', 'icon.svg', 'icon-192.png'];
